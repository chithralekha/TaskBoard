...
function popoverOnShow($timeout) {
        return {
            restrict:"A",
            link: function (scope, element, attrs) {
                if (!scope.$parent.$parent.FiltersList1 && scope.$first) {
                    element.popover({
                        trigger: "manual",
                        html: true,
                        content: "<div>!</div>",
                    ...
                    $timeout(function () { element.popover('hide'); }, 9000);
                }
            }
        }
    };
...
angular
    ...
    .directive('popoverOnShow',popoverOnShow)
